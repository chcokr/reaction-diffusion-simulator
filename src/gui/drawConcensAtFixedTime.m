...
function drawConcensAtFixedTime( ...
  concensAtEachStepFromTopOfRootToBottom, ...
...
for posIdxFromTop = 1:howManySpatialStepsAreThereAcrossTheRoot
  concen = concensAtEachStepFromTopOfRootToBottom(posIdxFromTop);
  ...
  rectLowerLeftY = (posIdxFromTop - 1) * howHighIsEachStep;
  rectangle( ...
